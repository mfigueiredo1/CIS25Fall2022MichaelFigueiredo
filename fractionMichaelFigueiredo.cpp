...
int FractionMichaelFigueiredo::getDenomMF() const {
    cout << "\n  While ::getDenomMF() is running!" << endl;
...
int FractionMichaelFigueiredo::getNumMF() const {
    cout << "\n  While ::getNumMF() is running!" << endl;
...
int FractionMichaelFigueiredo::isPalindromeMF() const {
    ...
    //cout << "\n  While ::isPalindromeMF() is running!" << endl;
    ...
    int n = 0;
    int d = 0;
    FractionMichaelFigueiredo frac;
    ...
    {
        cout << "\n  The Fraction at" << &frac << " is a Palindrome!" << endl << endl;
        return isTrueMF;
    }
    else
    {
